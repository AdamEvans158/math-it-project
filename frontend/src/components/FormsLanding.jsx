                        ...
                        <div className={styles.headBottom}>
                            ...
                            <div className={styles.optionsWrapper}>
                                <div className={styles.filtersContainer}>
                                    <button className={`${styles.filterButton} ${styles.activeFilter}`}
                                            onClick={(e) => {
                                ...
                                <div className={styles.subjectFiltersWrapper}>
                                    <div className={styles.currentSubjectButton}>{subjectFilter()}</div>
                                    ...
                                    {subjects.map(subject => {
                                            return (
                                                ...
                                                >
                                                    <div className={styles.subjectColor} style={{"background-color": subject.color1}}></div>
                                                    <div className={styles.subjectTextWrapper}>
                                                        <h4 className={styles.subjectText}>{subject.subject}</h4>
                                                    </div>
                                                </div>
                                            )
                                        })}
